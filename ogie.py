...
cl = LineClient(authToken='Evioj5aWg2UIllELA4n5.+W2HIHW2wSnL1YN7Yonkrq.u0KNra+qxmvXro89WoVqv3yAC/+ld7Szz5/PkzV8YmA=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

ki = LineClient(authToken='EvAcdcdnFlZI7xiWV2G7.4OrK1dGJazq1OyLlm4e5bW.z5iUZtbRTleNgDXLJtWqOJBUNeCKDSzggYlAkmEaaCI=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

kk = LineClient(authToken='EvOtxfeUEvoaTqDT6Eif.TFXxXOxiMHisMlrQ0+9NFW.6t2vHXcTSFTW9UisjKDYdrKRljKdwf1za2wM7gvjZDI=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

kc = LineClient(authToken='EvJbX5OylGoxqhVfWYq1.zpaRa1Xit30GIaDsH70oSq.uv/MrY5ImfUzcsxOGS98khgJh0JJayroiIRzZcP4MxY=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

cxb = LineClient(authToken='Evo2cCSyssejPKaZUx7f.r27FhZASkq/wIQYDnXdJdW.3za81jYuUvvteVCW35FjolXZXe/0OktDXURb4Xmc1qQ=')
...
wait = {
    ...
    "welcome":"★·.·´☠️`·.·★ ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴍʏ ʜᴇʟʟ ★·.·´☠️`·.·★",
    "comment":"ᴀᴜᴛᴏ ʟɪᴋᴇ ʙʏ....☠️⏩ PRILLY †ℯᾰՊℬ0七 ⏪☠️",
    "message":"ᴛʜᴀɴᴋs ғᴏʀ ᴀᴅᴅ ᴍᴇ\n☠️⏩ PRILLY †ℯᾰՊℬ0七 ⏪☠️\n\nᴏᴘᴇɴ ᴏʀᴅᴇʀ:\n☠️⏩ 1 Sb + 3 assist\n☠️⏩ 1 Sb + 5 assist\n☠️⏩ Bot Chat\n\nᴀɴᴅᴀ ᴍɪɴᴀᴛ..\nᴘᴍ ɢᴀɴ ☠️⏩ɪᴅ ʟɪɴᴇ : -arsyila03",
    }
...
def help():
    ...
    helpMessage = "❄☞ Selfbot Menu☜❄\n   ❄☞Gunakan「 " + key + " 」di depan☜❄\n\n" + \
                  ...
                  "❄☞ " + key + "Mykey\n" + \
                  "❄☞ " + key + "Resetkey\n" + \
                  "\n\n❄☞ Selfbot Hiburan☜ ❄ ❄☞Gunakan「 " + key + " 」di depan☜❄\n\n" + \
                  ...
                  "❄☞ " + key + "Spamcall" + \
                  "\n\n❄☞ Selfbot Protection☜❄  ❄☞Jangan gunakan「 " + key + " 」di depan☜❄\n\n" + \
                  "❄☞ " + key + "Notag「on/off」\n" + \
                  "❄☞ " + key + "Semuapro「on/off」\n" + \
                  ...
                  "\n\n❄☞ Selfbot Setting☜❄ ❄☞Jangan gunakan「 " + key + " 」di depan☜❄\n\n" + \
                  "❄☞ " + key + "Sticker「on/off」\n" + \
                  "❄☞ " + key + "Respon「on/off」\n" + \
                  "❄☞ " + key + "Contact「on/off」\n" + \
                  "❄☞ " + key + "Autojoin「on/off」\n" + \
                  ...
                  "\n\n❄☞ Selfbot Admin☜❄   ❄☞Jangan gunakan「 " + key + " 」di depan☜❄\n\n" + \
                  "❄☞ " + key + "Admin:on\n" + \
                  "❄☞ " + key + "Admin:repeat\n" + \
                  "❄☞ " + key + "Staff:on\n" + \
                  "❄☞ " + key + "Staff:repeat\n" + \
                  ...
                  "❄☞ " + key + "Listadmin\n" + \
                  "❄☞ " + key + "Listprotect\n\n" + \
                  "\n❄☞Ketik [Refresh]❄☞Setting By PRILLY Team☜❄"
    return helpMessage

def helpbot():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage1 = "❄☞ Selfbot Blacklist☜❄   ❄☞Jangan pakai「 " + key + " 」di depan☜❄\n\n" + \
                  "❄☞ " + key + "Blc\n" + \
                  "❄☞ " + key + "Ban:on\n" + \
                  "❄☞ " + key + "Unban:on\n" + \
                  "❄☞ " + key + "Ban「@」\n" + \
                  ...
                  "❄☞ " + key + "Clearban\n" + \
                  "❄☞ " + key + "Refresh" + \
                  "\n\n❄☞ Selfbot Menu☜❄   ❄☞pakai「 " + key + " 」di depan☜❄\n\n" + \
                  "❄☞ " + key + "Cek sider\n" + \
                  "❄☞ " + key + "Cek spam\n" + \
                  "❄☞ " + key + "Cek pesan \n" + \
                  "❄☞ " + key + "Cek respon \n" + \
                    ...
                    if text is None:
                        ...
                        if cmd == "bot on":
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                cl.sendText(msg.to,"❄☞ PRILLY Team Bot☜❄") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"❄☞ PRILLY Selfbot☜❄\n\n"+ma+"\n「%s」PRILLY Bot☜❄" %(str(len(Bots))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"❄☞ PRILLY List  admin☜❄\n\n❄☞Owner:\n"+ma+"\n❄☞Admin:\n"+mb+"\n❄☞Staff:\n"+mc+"\n「%s」❄☞PRILLY Selfbot☜❄☆" %(str(len(owner)+len(admin)+len(staff))))
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                ...
                                for i in gid:
                                    ...
                                    if h == ng:
                                        ki.sendMessage(i, "Please invit admin or staff PRILLY bot")
                                        ki.leaveGroup(i)
                                        kk.leaveGroup(i)
                                        kc.leaveGroup(i)
                            ...
                            if msg._from in admin:
                              if wait["blacklist"] == {}:
                                ...
                                for m_id in wait["blacklist"]:
                                    ...
                                    ma += str(a) + ". " +cl.getContact(m_id).displayName + "\n"
                                cl.sendMessage(msg.to,"❄☞ PRILLY Blacklist User☜❄\n\n"+ma+"\n❄☞「%s」Blacklist User☜❄" %(str(len(wait["blacklist"]))))
                            ...
                            if msg._from in admin:
                              if wait["Talkblacklist"] == {}:
                                ...
                                for m_id in wait["Talkblacklist"]:
                                    ...
                                    ma += str(a) + ". " +cl.getContact(m_id).displayName + "\n"
                                cl.sendMessage(msg.to,"❄☞ PRILLY Talkban User☜❄\n\n"+ma+"\n❄☞「%s」Talkban User☜❄" %(str(len(wait["Talkblacklist"]))))
