...
cl = LineClient(authToken='EqHZarFXwfZOEZ1ll2s5.xIpTHaB2kQycIrADLerGvq.k2OXBbLQh99WEh3wV0GK/Tj+YQKVt9Q1bKAcG69OVIU=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

ki = LineClient(authToken='Eqt7Oya30suw8Ujz1YMb.LlGfIBIDUEsdykqB7wmvMW.tiqJSZ49Z8llZM1/7mqGHdCoGI57hEDE0p7+tmAN97Y=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

kk = LineClient(authToken='EqkjMPcCB7hO3cyaHBCf.fQ5bN5KDl+BI+cpe6bg3BW.R2D6wflwCiLjDwkbFNkTGm7JpOr4CkywyR5ZxpuRuFc=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

kc = LineClient(authToken='EqU51uGec7rSOVIv1Mx4.+uJ1wkqg6gHzKON4opFkja.RTp7axdnhMPnJdZjpIFlvOSqgVnTQDgv9uBkNh/DQ7o=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

cxb = LineClient(authToken='EqBe5fkEkVUXtc2UkVg9.Vcm+YYcaaEG81OWsvqt1sq.wGH+m77jvYaXfP95x2bzXYjhFPFoj8a2rBUTsMgEmIE=')
...
poll = LinePoll(cl)
call = LineCall(cl)
creator = ["u8ab2c608abb32e945272e8d2ec3b33a6"]
owner = ["u8ab2c608abb32e945272e8d2ec3b33a6"]
admin = ["u5e23ed8406f62aa60289169d94446055"]
staff = ["u5e23ed8406f62aa60289169d94446055"]
...
def help():
    ...
    helpMessage = "❄☞ Selfbot Menu☜❄\n   ❄☞Gunakan「 " + key + " 」di depan☜❄\n\n" + \
                  ...
                  "❄☞ " + key + "Listadmin\n" + \
                  "❄☞ " + key + "Listprotect\n\n" + \
                  "\n❄☞Ketik [Refresh]❄☞Setting By CxB Team☜❄"
    return helpMessage
                    ...
                    if text is None:
                        ...
                        if cmd == "bot on":
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                cl.sendText(msg.to,"❄☞ CxB Team Bot☜❄") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"❄☞ CxB Selfbot☜❄\n\n"+ma+"\n「%s」CxB Bot☜❄" %(str(len(Bots))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"❄☞ CxB List  admin☜❄\n\n❄☞Owner:\n"+ma+"\n❄☞Admin:\n"+mb+"\n❄☞Staff:\n"+mc+"\n「%s」❄☞CxB Selfbot☜❄☆" %(str(len(owner)+len(admin)+len(staff))))
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                ...
                                for i in gid:
                                    ...
                                    if h == ng:
                                        ki.sendMessage(i, "Please invit admin or staff CxB bot")
                                        ki.leaveGroup(i)
                                        kk.leaveGroup(i)
                                        kc.leaveGroup(i)
