...
cl = LineClient(authToken='EqRgG7fMGRimZUz2VXC2.KJyizgzkdten8ali1aJMqG.BiIZzDvQzpiTRLBRRs9Wxiv3unhRvDwNL9OSBZ/MspI=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

ki = LineClient(authToken='Eq8QhZkF9pxKBMldSoJc.6DooAMCXbZZh8ycHBh1Zpa.wUzy/e2G1jInl5QG9e7K4Oow4hptXeqwYKDqn6zX9v4=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

kk = LineClient(authToken='EqHVji0bcDI7BPjFdlh5.DVRIqEI/cd7jg4Dfrvbp1q.FzaRVLVFyr3JFIUkx6F+wtS7sBjzJhYaOHdctdL3SDM=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

kc = LineClient(authToken='EqYmvUZou8PRrfKnjez3.ONRLe7m7Dz2faYPwOhj+8W.KYSsWRrbPFsR3qbJMQEnXdY6FCrhD8Rt8eC84N0yFTw=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

cxb = LineClient(authToken='EqKnHbjzjy3cKavU6b9e.htYEJehPzxMDGYj1JRtfNG.rftYMrM2rW9vUn/hK9CSxq2d8mQLoezzvLHLoch7AuE=')
...
staff = ["u92360864664a0d310df002c8d408e642"]
...
wait = {
    ...
    "message":"ᴛʜᴀɴᴋs ғᴏʀ ᴀᴅᴅ ᴍᴇ\n❄☞PRILLY ᴛᴇᴀᴍ ʙᴏᴛ☜❄\n\nᴏᴘᴇɴ ᴏʀᴅᴇʀ:\n❄☞ 1 Sb + 3 assist\n☞ 1 Sb + 5 assist\n\nᴀɴᴅᴀ ᴍɪɴᴀᴛ..\nᴍɪɴᴀᴛ ᴄᴘᴄ ɢʜᴀɴ ❄☞ʟᴅ ʟɪɴᴇ : -arsyila",
    }
